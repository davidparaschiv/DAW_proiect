...
namespace HttpTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<FollowsTableClient>();
            services.AddHttpClient<PostClient>();
            services.AddHttpClient<ProfileClient>();
            services.AddHttpClient<ToSeeListItemClient>();

            // define controllers as services (for DI)
            services.AddMvc().AddControllersAsServices();

            // prepare ProfileController for DI in Razor view
